...
export default async function AIDialog() {
    ...
    return (
        <DialogClient>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle className="flex flex-row gap-2 items-center mb-4"><CohereIcon />Cohere Rerank</DialogTitle>
                    <DialogDescription>
                        <Suspense fallback={<div>Reranking items...</div>}>
                            <Rerank purchases={purchases} />
                        </Suspense>
                    </DialogDescription>
                </DialogHeader>
            </DialogContent>
...
function CohereIcon({
    ...
    return (
        <svg width="24" height="24" viewBox="0 0 75 75" xmlns="http://www.w3.org/2000/svg" className={className}>
			<path
